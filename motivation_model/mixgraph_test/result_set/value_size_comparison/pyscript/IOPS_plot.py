...
def create_data_table(conn):
    ...
    c.execute("CREATE TABLE %s (value_size TEXT, media TEXT, cpu TEXT, batch_size text," % SPEED_TABLE_NAME +
...
def plot_single_graph(paint_df, IOPS_or_latency="IOPS"):
    ...
    fig = px.bar(paint_df, x="value_size", y=IOPS_or_latency, color="media", barmode="group",
                 facet_col="cpu",
